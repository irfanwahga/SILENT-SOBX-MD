...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || "SILENT-SOBX-MD~WFoFUaZJ#M2SnO-B5i_YDvbUs8MnwTAWrg7MAhmHSuc5pfpXoM6c",
    ...
    STATUS_REPLY: process.env.STATUS_REPLY || "`➺үσυя sтαтυs sεεη נυsт ησω вү IRFAN WAHGA`",
